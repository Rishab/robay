		...
		if (acc_type.equals("A")) {
			...
			%>
				...
				<div class="center-text margin-up">
					<h2>
						<em>Staff Account creation</em>
					</h2>
				</div>
				<%
					//Get parameters from the HTML form at the register.jsp
					String newName = request.getParameter("name").replaceAll("\'","\\\\'");
					String newEmail = request.getParameter("email").replaceAll("\'","\\\\'");
				...
				<script>
					...
					window.location.href = "registerstaff.jsp";
				</script>
				<%
					return;
						}
				...
				<%
					return;
						...
						//insert in table
						String insertStr = "INSERT INTO Account (name_user, pass_hash, email_addr, acc_type)"
								+ " VALUES (?, ?, ?, 'S')";
				...
				<script>
					...
					window.location.href = "admincontrols.jsp";
				</script>
				<%
					} catch (Exception e) {
